...
// // Функция для выполнения ходов игроками
// string[,] TakeInput(string[,] xo_massiv)
// {
//     int index = 1;
...
//         if (xo_massiv[x1, x2] == "x" || xo_massiv[x1, x2] == "o" || x1 > 3 || x1 < 1 || x2 > 3 || x2 < 1) TakeInput(xo_massiv);
//         else
//         {
//             xo_massiv[x1, x2] = "x";
//             Console.WriteLine();
...
//         if(xo_massiv[y1, y2] == "x" || xo_massiv[y1, y2] == "o" || y1 > 3 || y1 < 1 || y2 > 3 || y2 < 1) TakeInput(xo_massiv);
//         else
//         {
//         xo_massiv[y1, y2] = "o";
//         Console.WriteLine();
...
//         for (int j = 0; j < xo_massiv.GetLength(1); j++)
//         {
//             if (xo_massiv[1, j] != "." && xo_massiv[2, j] != "."
//             && xo_massiv[3, j] != "." && xo_massiv[i, 1] != "."
//             && xo_massiv[i, 2] != "." && xo_massiv[i, 3] != "."
//             && xo_massiv[1, 1] != "." && xo_massiv[2, 2] != "."
//             && xo_massiv[3, 3] != "." && xo_massiv[1, 3] != "."
//             && xo_massiv[2, 2] != "." && xo_massiv[3, 1] != ".") Player = "Draw!";
